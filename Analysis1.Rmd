...
The figure below whos the variation in objectivism rating at both the person and item levels.
...
$$\beta_{0(j, k)} = \gamma_{00} + \beta_{1j}Condition + \beta_{2k}perceived\_agreement + u_{0j} + v_{0k}$$
...
msummary_mixed(list("random-intercept" = m0,
                    "model 1" = m1))
